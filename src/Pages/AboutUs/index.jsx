                        ...
                        <div className='lg:order-2 order-1'>
                            ...
                            <div className='border-l-4 border-gray-800 pl-5'>
                                <p className="text-gray-600 md:text-lg text-sm mb-4 text-justify">
                                    At <strong>VERDE</strong>, we simplify your daily commute with reliable and affordable ride options. Whether you need a quick auto for a nearby errand, a two-wheeler for zipping through traffic, or a comfortable cab for longer rides—we’ve got you covered.
                                </p>
                                ...
                                <p className="mt-4 text-gray-700 font-medium">Ride smart. Ride safe. Ride with VERDE.</p>
                            </div>
